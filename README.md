## :mortar_board: Building an R Package <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/R_logo.svg/724px-R_logo.svg.png" height="120" align="right"/>

[![License: CC
BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgreen.svg)](https://choosealicense.com/licenses/cc-by-4.0/)


Code used to create the online presentation **Building an R Package** available at:
[**rdatatoolbox.github.io/course-rpackage**](https://rdatatoolbox.github.io/course-rpackage)
