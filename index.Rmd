...
`r fontawesome::fa_i("hand-point-right")` &nbsp;Check that the chosen name is not already in use with `available::available("nomdupackage")`
...
- First, we will create a new empty `r fontawesome::fa_i("r-project")` file in the folder **R/**.
...
.pull-leftt[
.center[[![:scale 75%](img/hex-quarto.png)](https://quarto.org/)]
]

.pull-rightt[
- A tutorial for your package
- Shows how to use your package
- Uses the syntax `markdown`
]
