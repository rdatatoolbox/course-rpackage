...
.center[
[![:scale 27.8%](img/r-pkg.png)](https://r-pkgs.org/)
&nbsp;
[![:scale 27.4%](img/r-ext.jpg)](https://cran.r-project.org/doc/manuals/r-release/R-exts.html)
&nbsp;
[![:scale 25.0%](img/chambers.jpg)](https://www.taylorfrancis.com/books/9781315381305)
]
...
.center[
![:scale 45.0%](img/rstudio.png)
]

.center[
![:scale 15.0%](img/hex-devtools.png)
![:scale 15.0%](img/hex-usethis.png)
![:scale 15.0%](img/hex-roxygen2.png)
![:scale 15.0%](img/hex-rmarkdown.png)
![:scale 15.0%](img/hex-testthat.png)
]
.center[
![:scale 25.0%](img/up-to-date.jpg)
]
...
- the whole package, with the tag `@import`:
```{r, echo = TRUE, eval = FALSE}
#' @import stats
```

- or only a specific function from a package, with the tag `@importFrom`:
```{r, echo = TRUE, eval = FALSE}
#' @importFrom stats na.omit
```
